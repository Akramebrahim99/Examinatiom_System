                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{route('teacher.editquestioninfo',[$question->id])}}" class="add-teacher-model">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Enter Option {{$count}}</label>
                                        <input style="width: 50%;" required="required" type="text" name="option{{$count}}" placeholder="Enter Option {{$count}}" class="form-control" value="{{$answer->answer}}">
                                    </div>
                                </div>
                                <?php $count++; ?>
                                @endforeach
                            ...
                            <label style="color: green;">Correct Answer Is: <span style="color: red;width:100%">{{$question->correct_answer}}</span> </label>
